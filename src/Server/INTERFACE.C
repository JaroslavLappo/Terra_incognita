...
void SendPropInfo(GAME Game)
{
  ...
  sprintf(PropInfo, "Gametype:%s\nSize:%iX%i\nLenght of River:%i\n"
    "Number of Armoryies:%i\nNumber of Healers:%i\nNumber of Wormholes:%i\n",
    /*GTfromType(properties.gametype)*/"Normal game", properties.W, properties.H, properties.RiverLength, properties.ArmoriesNumber,
    properties.HealersNumber, 0);
